...
test('AU journey', async ({ page }) => {

    await page.goto('https://www.coversandall.com.au/');
    // Wait for banner to be visible before interacting
    const bannerLocator = page.locator("//p[contains(normalize-space(),'Use code:')]");
    await bannerLocator.waitFor({ state: 'visible' });
    ...
    await page.locator(`input[name="couponCode"][type="text"][placeholder="Enter Discount Code"]`).fill(codeText);
    await page.waitForTimeout(9000);
